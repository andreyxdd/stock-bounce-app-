...
export const termDescription = {
  short: {
    title: 'Short',
    desc: 'Among stocks that has fallen during the selected period (accumulativly over the numnber of selected periods) the table shows selection of stocks that show the positive change between OP and CP on the current trading day (T + 2). The stocks are sorted by this CP-OP difference.',
  },
  long: {
    title: 'Long',
